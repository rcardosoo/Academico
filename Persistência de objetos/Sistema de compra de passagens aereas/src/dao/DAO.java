...
public class DAO<T> implements DAOInterface<T> {
	...
	public static void abrir(){
		if(manager==null){
			...
			properties.put(PersistenceUnitProperties.JDBC_URL, "jdbc:mysql://127.0.0.1:3306/aerobd");
			...
			EntityManagerFactory factory = 
					Persistence.createEntityManagerFactory("aerobd", properties);
	...
	public List<T> listar(){
		...
		Query query = manager.createQuery("select obj from " + type.getSimpleName() + " obj");
	...
	//public static void efetivarparcial(){		//commit parcial
	//	manager.flush();
	//}
